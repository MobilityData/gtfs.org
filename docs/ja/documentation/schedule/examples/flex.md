...
デマンド レスポンシブ サービスには、世界の地域に基づいて異なる用語が存在することに注意してください。詳細については、[用語集](#_19) を参照してください。
...
ニュー アルム市ゾーンはブラウン郡ゾーンに含まれます。 ["ゾーン重複制約"](#_18) の問題を回避するために、ハートランド エクスプレスは 4 つのトリップで定義できます。
