...
**Pre-requirements**: Implement with rest of base features
...
??? note "Sample Data"
    ...
    The following table shows basic agency information provided for this file.
    </p>
    !!! note ""
        <p style="font-size:16px">
...
??? note "Sample Data"
    <p style="font-size:16px">
    The following table defines a stop providing basic information elements to identify it and locate the stop.
    </p>
    !!! note ""
        <p style="font-size:16px">
...
??? note "Sample Data"
    <p style="font-size:16px">
    The following table defines a bus route (`route_type=3`).
    </p>
    !!! note ""
        <p style="font-size:16px">
...
??? note "Sample Data"
    <p style="font-size:16px">
    The following tables define two services (weekday and weekend) for the month of July, 2024, including a special holiday service on July 4th, operating as a weekend service.
    </p>
    !!! note ""
        <p style="font-size:16px">
...
??? note "Sample Data"
    <p style="font-size:16px">
    The following table defines two trips running in both directions for the RA route.
    </p>
    !!! note ""
        <p style="font-size:16px">
...
??? note "Sample Data"
    <p style="font-size:16px">
    The following table defines the schedule for a trip at 5 stops.
    </p>
    !!! note ""
        <p style="font-size:16px">
