...
??? note "Sample Data"
    ...
    The following table shows three different transfers: one between stops that requires a minimum transfer time of 5 minutes, one timed transfer point between two routes, and one in-seat transfer between two trips made by the same vehicle.
    </p>
    !!! note ""
        <p style="font-size:16px">
