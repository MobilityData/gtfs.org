# GTFS Realtime Protobuf
 Téléchargez le fichier [gtfs-realtime.proto](gtfs-realtime.proto) et utilisez-le pour compiler votre flux GTFS-realtime. Le contenu du fichier est affiché en ligne ci-dessous. 
 Pour plus d’informations sur l’utilisation de protobufs, consultez le [Protocol Buffers Developer Guide](https://developers.google.com/protocol-buffers/docs/overview). 
```protobuf
