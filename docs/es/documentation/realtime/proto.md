...
Descargue el archivo [gtfs-realtime.proto](gtfs-realtime.proto) y úselo para compilar su feed GTFS-realtime. Los contenidos de este archivo se muestran más abajo.
Para más informacion sobre como usar protobufs, vea el [Protocol Buffers Developer Guide](https://developers.google.com/protocol-buffers/docs/overview).
```protobuf
