 ...
 **Revisado el 28 de octubre de 2025. Consulte [Historial de revisiones](../change-history/revision-history) para obtener más detalles.** 
...
### fare_transfer_rules.txt 
 ...
 1. Los grupos de tramos tarifarios aplicables definidos en `fare_leg_rules.txt` deben determinarse para todos los tramos individuales o tramos tarifarios efectivos del viaje según el trayecto del pasajero.
