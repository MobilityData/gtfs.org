...
#### Octubre de 2025
* Se agregaron aclaraciones para `fare_transfer_rules.txt` y se introdujo un nuevo tipo de campo `a` local`. Consulte [discusión](https:(https://github.com/google/transit/pull/561).
