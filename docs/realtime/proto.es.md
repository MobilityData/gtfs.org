...
Descargue el archivo [gtfs-realtime.proto](gtfs-realtime.proto) y utilícelo para compilar su fuente GTFS-realtime. Para obtener más información sobre el uso de protobufs, consulte la [Guía del desarrollador de búferes de protocolo](https://developers.google.com/protocol-buffers/docs/overview).
