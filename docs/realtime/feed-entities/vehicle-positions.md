<a class="pencil-link" href="https://github.com/google/transit/edit/master/gtfs-realtime/spec/en/vehicle-positions.md" title="Edit this page" target="_blank">
...
The trip that the vehicle is currently serving should be given through a [TripDescriptor](../reference.mdmessage-tripdescriptor). You can also provide a [VehicleDescriptor](../reference.mdmessage-vehicledescriptor), which specifies a precise physical vehicle that you are providing updates about. Documentation is provided below.
