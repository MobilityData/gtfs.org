# GTFS-Realtime プロトブーフ

[gtfs-realtime.proto](gtfs-realtime.proto)ファイルをダウンロードして、GTFS-realtimeフィードをコンパイルするために使用します。protobufの使い方については、[Protocol Buffers Developer Guideを](https://developers.google.com/protocol-buffers/docs/overview)参照してください。
