...
[gtfs-realtime.proto](gtfs-realtime.proto) 파일을 다운로드하고 이를 사용하여 GTFS-realtime 피드를 컴파일합니다. 파일 내용은 아래 인라인으로 표시됩니다. protobufs 사용에 대한 자세한 내용은 [Protocol Buffers Developer Guide](https://developers.google.com/protocol-buffers/docs/overview) 를 참조하십시오.
