...
header {
  ...
  # определяет, является ли набор данных инкрементным или полный
  incrementality: FULL_DATASET

  # время, когда этот набор данных был создан на сервере
...
entity {
  ...
  # "тип" entity
    ...
    active_period {
      # время начала в формате эпохи POSIX
      start: 1284457468
      # время окончания в формате эпохи POSIX
      end: 1284468072
    }
    ...
    # несколько селекторов (informed_entity) могут быть включены в один entity Alert
    informed_entity {
      stop_id: "16230"
    }
    ...
    # описаниеAlert. Дополнительная Информация к текст header
    description_text {
      # поддержка нескольких языков/переводов
      translation {
