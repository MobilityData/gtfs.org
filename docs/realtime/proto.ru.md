# Протобуф GTFS Realtime

Загрузите файл [gtfs-realtime.proto](gtfs-realtime.proto) и используйте его для компиляции вашего канала GTFS-realtime. Для получения дополнительной информации об использовании протобуфов смотрите [Руководство разработчика буферов протокола](https://developers.google.com/protocol-buffers/docs/overview).
