...
このGTFSフィードの例では、トランジットフィード内の各ファイルについて、カンマ区切りでデータサンプルを示しています。ここに示されたサンプルデータファイルは、すべてが互いに関連しているわけではありません。また、最終形式の[完全なGTFSフィードを](https://github.com/google/transit/blob/master/gtfs/spec/en/examples/sample-feed-1.zip?raw=true)[ダウンロードし]((https://github.com/google/transit/tree/master/gtfs/spec/en/examples/sample-feed-1))て作業することもできますし、同じフィードの個々のファイルをオンライ[ンで閲覧することもできます](https://github.com/google/transit/tree/master/gtfs/spec/en/examples/sample-feed-1)。
