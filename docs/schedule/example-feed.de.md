...
Dieses Beispiel zeigt Serviceausnahmen für den Unabhängigkeitstag im Jahr 2006. Am Montag, dem 3. Juli 2006, wird der reguläre Wochentagsverkehr`(service_id=WD`) unterbrochen`(exception_type=2`). Stattdessen verkehrt an diesem Tag ein Wochenenddienst`(service_id=WE`)`(exception_type=1`). Die gleiche Änderung gilt auch für Dienstag, den 4. Juli.
