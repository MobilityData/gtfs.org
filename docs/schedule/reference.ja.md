...
[fare_rules.txt](#farerulestxt)と[fare_attributes.txt](#fareattributestxt) を使用して運賃構造を指定する方法を示す例については、GoogleTransitDataFeed オープンソースプロジェクトの wiki にある<https://code.google.com/p/googletransitdatafeed/wiki/FareExamples>を参照してください。
