...
# Exemplo de feed GTFS

Este exemplo de alimentação GTFS mostra amostras de dados delimitados por vírgula para cada arquivo em uma alimentação em trânsito. Os arquivos de dados de amostra mostrados aqui não são todos relacionados uns aos outros. Você também pode [baixar um feed GTFS completo](https://github.com/google/transit/blob/master/gtfs/spec/en/examples/sample-feed-1.zip?raw=true) na forma final para trabalhar também, ou navegar pelos arquivos individuais desse mesmo feed on-line [aqui](https://github.com/google/transit/tree/master/gtfs/spec/en/examples/sample-feed-1).
...
`location_type=` 0: plataforma; 1: estação; 2: entrada/saída; 3: nó genérico; 4: área de embarque.
