...
| :---- | :---- | :---- |
| [**Fare Media**](../../../../../getting-started/features/fares/#fare-media)<br>(see [example](../fare-media))| The supported media that can be used to hold and/or validate a fare product (eg: cash, contactless, physical card, etc.). | `fare_media.txt`, `fare_products.txt` |
