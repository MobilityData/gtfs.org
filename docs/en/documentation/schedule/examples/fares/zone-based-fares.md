...
In this example, multiple leg groups are added for each possible zone combination. For example, ZN1_ZN1 is the leg that remains within Zone 1 because from_area_id=ZN1 and to_area_id=ZN1. ZN1_ZN1 is associated with the 1_zone_fare fare_product. 
