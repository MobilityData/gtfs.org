...
For the major part, it has been adopted in GTFS in March 2024. Some examples can be found on [this page](../../../en/community/extensions/flex.md) showing what can be modeled using the officially adopted part of GTFS Flex.
