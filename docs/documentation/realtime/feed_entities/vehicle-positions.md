...
The trip that the vehicle is currently serving should be given through a [TripDescriptor](../../reference/#message-tripdescriptor). You can also provide a [VehicleDescriptor](../../reference/#message-vehicledescriptor), which specifies a precise physical vehicle that you are providing updates about. Documentation is provided below.
